              ...
              <ul className="counter-box clearfix">
                <li>
                  <div className="counter-item">
                    ...
                    <h4 className="count" data-count="99">99</h4>
                ...
                <li>
                  <div className="counter-item">
                    ...
                    <h4 className="count" data-count="45">45</h4>
                ...
                <li>
                  <div className="counter-item">
                    ...
                    <h4 className="count" data-count="125">125</h4>
                ...
                <li>
                  <div className="counter-item">
                    ...
                    <h4 className="count" data-count="200">200</h4>
